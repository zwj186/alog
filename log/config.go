...
func LoadDefaultConfig() *LogConfig {
	...
	config.Console.Level = DefaultLogLevel
	config.Console.Item.Tmpl = DefaultConsoleTmpl
	config.Console.Item.TimeTmpl = DefaultConsoleTimeTmpl
	config.Global.IsReload = false
	config.Global.IsEnabled = DefaultEnabled
	config.Global.IsPrint = DefaultPrint
	config.Global.Rule = AlwaysRule
	config.Global.Level = DefaultLogLevel
	config.Global.Buffer.Engine = MEMORY_BUFFER
	config.Global.Interval = DefaultInterval
	config.Global.ShowFile = DefaultShowFile
	config.Global.FileCaller = DefaultFileCaller
